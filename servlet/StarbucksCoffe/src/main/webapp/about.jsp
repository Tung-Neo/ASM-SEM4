...
<!-- Mirrored from priteshgupta.com/demos/templates/connoisseur/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Jun 2021 04:43:29 GMT -->
    ...
    <header>
        <nav>
            <ul id="nav">
                ...
                <li><a href="ViewCustomerControllerServlet">Prodcut</a></li>
    ...
    <div class="wrapper">
        ...
        <article>
            ...
            <p><strong>Pellentesque habitant morbi tristique</strong> senectus et netus et malesuada fames ac turpis
                ...
                condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. <a href="#">Donec non
                    enim</a> in turpis pulvinar facilisis. Ut felis.</p>
...
&lt;/hgroup&gt;
            ...
            <blockquote>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam consectetur elementum molestie.
                    Donec eget orci vitae felis malesuada gravida a a magna. Nulla quis nisi dui. Aliquam eu risus
                    et dui tempus pretium. Nunc vulputate ante ut dui cursus ultricies. Aliquam eu arcu et neque
                    molestie porta vitae quis magna. Quisque convallis, justo in sagittis egestas, arcu diam
                    malesuada eros, non dignissim turpis lacus sed dolor.</p>
            </blockquote>
        </article>
        <aside class="sidebar">
